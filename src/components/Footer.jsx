...
function Footer() {
  ...
  return (
    <footer className="footer-All">
      <p
        className=" back-to-tob"
        onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}
      >
        Back to top
      </p>

      <div className="div-footer-All">
        <div className="total-right">
          <div className="text-right-form-h3">
            <div className="text-h3">
              <Link className="text-h3-ind" to="/">
                Get your watch now .
              </Link>
            </div>
            <div className="text-form">
              <form
                ...
                className="onside-form-All"
              >
                <div className="svg-emil">
                  <svg
                    className="svg-one"
                ...
                <button className="button-subscr">Subscribe</button>
              </form>
            </div>
          </div>
          <div className="label-text-links">
            {footerNavs.map((item, idx) => (
              <ul className="ul-text-form" key={idx}>
                <h4 className="h4-text">{item.label}</h4>
                {item.items.map((el, idx) => (
                  <li key={idx}>
                    <a href={el.href} className="href-el">
                      {el.name}
                    </a>
                  </li>
                ))}
        ...
        <div className="text-left">
          <p className="text-prgrph">
            © 2025 Float UI Inc. All rights reserved.
          </p>
          <div className="section-icon-footer">
            <a href="javascript:void()">
              <svg className="svg-tow" fill="none" viewBox="0 0 48 48">
                <g clip-path="url(#a)">
                  <path
                    fill="currentColor"
            ...
            <a href="javascript:void()">
              <svg className="svg-tow" fill="currentColor" viewBox="0 0 48 48">
